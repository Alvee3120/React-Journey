  ...
  return (
    <>
      ...
      >
        ...
        {/* Main Card */}
        <div className=" md:w-[50vw] w-[80vw]  rounded-2xl h-[80vh] shadow-2xl bg-[#382866] relative z-10">
...
<h2 className='mt-3 text-center text-3xl font-normal text-white'>{displaycity}, {country}</h2>
            ...
            <div id="subresult" className=" flex gap-16 justify-between  m-12 text-white mt-6">
              <div id="item1" className="flex flex-col gap-2">
                <p>Feels Like: {feelslike}°C</p>
                <p>Minimum Temperature: {mintemp}°C</p>
                <p>Maximum Temperature: {maxtemp}°C</p>
              </div>
              <div id="item2" className="flex flex-col gap-2">
